...
import { ArrowLeft, Download, Printer, FileText, CheckCircle, XCircle } from "lucide-react";
...
const GRNView: React.FC = () => {
    ...
    return (
        <DashboardLayout>
            ...
            {/* Main Card */}
            <Card className="w-full max-w-7xl mx-auto border-1 border-gray-100 shadow-lg print:border-0 print:shadow-none">
                {/* Header Section */}
                <CardHeader className="text-center   print:bg-white">
                ...
                <CardContent className="p-8 bg-white">
                    ...
                    {grnData.status === "Rejected" && (
                        <div className="mb-8 p-6 bg-red-50 border-2 border-red-500 rounded-lg print:hidden">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-red-700 text-sm mt-1">
                                        This Goods Received Note has been rejected and requires review.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    {/* GRN Details Section */}
                    <div className="mb-10  p-8 rounded-lg border-1 border-gray-100 print:border print:bg-white -mt-16">
                        <h3 className="text-lg font-bold text-gray-800 mb-6 pb-2  border-gray-200">
                            GRN Information
                        </h3>
                    ...
                    <div className="mb-8">
                        ...
                        <div className="rounded-lg overflow-hidden border-1 border-gray-200 shadow-sm">
                            <Table>
                                <TableHeader>
                    ...
                    <div className="mb-8 flex justify-end">
                        <div className="w-full md:w-1/2 lg:w-1/3 border-2 border-gray-100 rounded-lg p-6 shadow-sm">
                            <h3 className="text-lg font-bold text-gray-800 mb-4 pb-2 border-b-2 border-gray-100">
                                Summary
                            </h3>
